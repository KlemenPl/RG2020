...
void MouseCameraController::setup()
{
    ...
    Input::addKeyEvent(KeyEvent(KEY_W, PRESS,
                                [this, moveSpeed]() -> bool {
                                    this->camera->translateWFront(0,0,moveSpeed);
                                    return false;
                                }));
    Input::addKeyEvent(KeyEvent(KEY_S, PRESS,
                                [this, moveSpeed]() -> bool {
                                    this->camera->translateWFront(0,0,-moveSpeed);
                                    return false;
                                }));
    Input::addKeyEvent(KeyEvent(KEY_A, PRESS,
                                [this, moveSpeed]() -> bool {
                                    this->camera->translateWFront(-moveSpeed,0,0);
                                    return false;
                                }));
    Input::addKeyEvent(KeyEvent(KEY_D, PRESS,
                                [this, moveSpeed]() -> bool {
                                    this->camera->translateWFront(moveSpeed,0,0);
                                    return false;
                                }));
    Input::addKeyEvent(KeyEvent(KEY_SPACE, PRESS,
                                [this, moveSpeed]() -> bool {
                                    this->camera->translateWFront(0,moveSpeed,0);
                                    return false;
                                }));
    Input::addKeyEvent(KeyEvent(KEY_LEFT_CONTROL, PRESS,
                                [this, moveSpeed]() -> bool {
                                    this->camera->translateWFront(0,-moveSpeed,0);
                                    return false;
                                }));
