...
void MouseCameraController::setup()
{
    ...
    Input::addKeyEvent(KeyEvent(KEY_W, PRESS | REPEAT,
                                [this, moveSpeed]() -> bool {
                                    this->camera->translateWFront(0, 0, moveSpeed);
                                    return false;
                                }));
    Input::addKeyEvent(KeyEvent(KEY_S, PRESS | REPEAT,
                                [this, moveSpeed]() -> bool {
                                    this->camera->translateWFront(0, 0, -moveSpeed);
                                    return false;
                                }));
    Input::addKeyEvent(KeyEvent(KEY_A, PRESS | REPEAT,
                                [this, moveSpeed]() -> bool {
                                    this->camera->translateWFront(-moveSpeed, 0, 0);
                                    return false;
                                }));
    Input::addKeyEvent(KeyEvent(KEY_D, PRESS | REPEAT,
                                [this, moveSpeed]() -> bool {
                                    this->camera->translateWFront(moveSpeed, 0, 0);
                                    return false;
                                }));
    Input::addKeyEvent(KeyEvent(KEY_SPACE, PRESS | REPEAT,
                                [this, moveSpeed]() -> bool {
                                    this->camera->translateWFront(0, moveSpeed, 0);
                                    return false;
                                }));
    Input::addKeyEvent(KeyEvent(KEY_LEFT_CONTROL, PRESS | REPEAT,
                                [this, moveSpeed]() -> bool {
                                    this->camera->translateWFront(0, -moveSpeed, 0);
                                    return false;
                                }));
